...
\newcommand{\X}{$\bullet$}
\newcommand{\stack}[2]{\vtop{\hbox{\strut #1}\hbox{\strut #2}}}
\newcommand{\stackt}[3]{{\vtop{\hbox{\strut #1}\hbox{\strut #2}\hbox{\strut #3}}}}
\newcommand{\vertical}[1]{\rotatebox[origin=l]{90}{#1}}
...
\newcommand{\perturb}{{\sc Attract}\xspace}
\newcommand{\thb}{^{\mbox{\scriptsize th}}}
\newcommand{\partiallytested}{partially-required}
\newcommand{\pseudotested}{pseudo-tested}
\newcommand{\Pseudotested}{Pseudo-tested}
\newcommand{\tested}{required}
\newcommand{\notcovered}{not-covered}
\newcommand{\theoriginalauthors}{Niedermayr et al. \cite{niedermayr_will_2016}\xspace}
\newcommand{\tabincell}[2]{\begin{tabular}{@{}#1@{}}#2\end{tabular}}

\newcommand{\dspotprettifier}{DSpot-prettifier\xspace}
