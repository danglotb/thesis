...
In this chapter, I gave technical details about \dspot.
...
A first scenario where \dspot improve the mutation score of existing test suite of open-source projects from \gh.
The test-criterion improved is mutation score, and output of \dspot is evaluated by external developers.
